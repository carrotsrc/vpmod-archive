 ...
 */
	class vp_userman_uiPanel extends Panel
	{
		public function __construct()
		{
			parent::__construct();
			$this->setModuleName('vp_userman_ui');
			$this->jsCommon = "OK_UsermanInterface";
		}
		...
		public function setAssets()
		{
			...
			$this->addAsset('js', "template/userman_sc.js");
			$this->addAsset('css', "template/userman_style.css");
