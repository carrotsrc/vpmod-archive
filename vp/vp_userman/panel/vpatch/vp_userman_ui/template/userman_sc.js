...
function OK_UsermanInterface() {
	...
	this.uio_userList = function (list) {
		...
		u = KTSet.NodeUtl(self.getElementById("grouplist"));
		u.clearChildren();
		u.appendChild(r);
	}
...
OK_UsermanInterface.prototype = new KitJS.PanelInterface('vp_userman_ui');
